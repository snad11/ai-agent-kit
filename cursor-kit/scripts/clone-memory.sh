...
# The anchor is committed to the project repo, so never write an absolute home
# path into it -- collapse $HOME to '~' for every source reference.
MEMDIR_DISPLAY="~${MEMDIR#"$HOME"}"
